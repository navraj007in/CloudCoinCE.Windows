...
namespace CloudCoinClient.CoreClasses
{
    public class FileSystem : IFileSystem
    {
        ...
        public FileSystem(string RootPath)
        {
            ...
            ExportFolder = RootPath + Config.TAG_EXPORT + Path.DirectorySeparatorChar;
            ImportedFolder = RootPath + Config.TAG_IMPORTED + Path.DirectorySeparatorChar;
            TemplateFolder = RootPath  + Config.TAG_TEMPLATES + Path.DirectorySeparatorChar;
            LanguageFolder = RootPath  + Config.TAG_LANGUAGE + Path.DirectorySeparatorChar;
            CounterfeitFolder = RootPath + Config.TAG_COUNTERFEIT + Path.DirectorySeparatorChar;
            PartialFolder = RootPath + Config.TAG_PARTIAL + Path.DirectorySeparatorChar;
            FrackedFolder = RootPath + Config.TAG_FRACKED + Path.DirectorySeparatorChar;
            DetectedFolder = RootPath+ Config.TAG_DETECTED + Path.DirectorySeparatorChar;
            SuspectFolder = RootPath + Config.TAG_SUSPECT + Path.DirectorySeparatorChar;
            TrashFolder = RootPath + Config.TAG_TRASH + Path.DirectorySeparatorChar;
            BankFolder = RootPath + Config.TAG_BANK + Path.DirectorySeparatorChar;
            PreDetectFolder = RootPath  + Config.TAG_PREDETECT + Path.DirectorySeparatorChar;
            LostFolder = RootPath  + Config.TAG_LOST + Path.DirectorySeparatorChar;
            RequestsFolder = RootPath  + Config.TAG_REQUESTS + Path.DirectorySeparatorChar;
            DangerousFolder = RootPath  + Config.TAG_DANGEROUS + Path.DirectorySeparatorChar;
            LogsFolder = RootPath  + Config.TAG_LOGS + Path.DirectorySeparatorChar;
            ResponseFolder = RootPath + Config.TAG_RESPONSE + Path.DirectorySeparatorChar;
